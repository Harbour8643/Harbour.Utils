...
namespace Harbour.Utils
{
    static class MimeData
    {
        ...
        private static string mimeData = @"xlsx    application/vnd.openxmlformats-officedocument.spreadsheetml.sheet
